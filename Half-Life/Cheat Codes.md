...
- ❤️ **`DREAMCAST`** **`LOVES`** **`HEADCRABS`** - Get Well Soon
...
- ⌨️ **`FILES`** **`AND`** **`FEAR`** - Office Complex
...
- ☣️ **`RECYCLE`** **`OR`** **`DIE`** - Residue Processing
- 🧪 **`REGRESSION`** **`BRINGS`** **`PROGRESS`** - Questionable Ethics
- 🧫 **`COMBAT`** **`AND`** **`DEATH`** - Surface Tension
- ⚠️ **`SOLDIERS`** **`EAT`** **`TACOS`** - Forget About Freeman
- ☢️ **`SCIENTISTS`** **`AT`** **`WORK`** - Lambda Core
- 💫 **`FEAR`** **`AND`** **`GRAVITY`** - Xen
- 🕸️ **`PANIC`** **`IN`** **`XEN`** - Interloper
...
- ⚡️ **`POWER`** **`IS`** **`PROGRESS`** - Power Struggle
- 🏜️ **`PHYSICS`** **`IS`** **`BEAUTIFUL`** - A Leap of Faith
